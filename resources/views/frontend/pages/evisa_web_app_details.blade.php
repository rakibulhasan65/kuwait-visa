...
<body>
    ...
    <div class="flex text-white" style="background: #36456e; font-size: 0.7rem; font-weight: 800;">
        ...
        <button onclick="showTab('qr')" id="tab-qr"
            class="flex-1 text-center py-3 px-4 flex items-center justify-center gap-2 border-b-2 border-transparent hover:border-blue-400 focus:outline-none">
            <svg class="w-5 h-5" style="margin-right: -22px;" fill="currentColor" viewBox="0 0 24 24">
                <path
            ...
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><title>ionicons-v5-k</title><rect x="336" y="336" width="80" height="80" rx="8" ry="8"></rect><rect x="272" y="272" width="64" height="64" rx="8" ry="8"></rect><rect x="416" y="416" width="64" height="64" rx="8" ry="8"></rect><rect x="432" y="272" width="48" height="48" rx="8" ry="8"></rect><rect x="272" y="432" width="48" height="48" rx="8" ry="8"></rect><path d="M448,32H304a32,32,0,0,0-32,32V208a32,32,0,0,0,32,32H448a32,32,0,0,0,32-32V64A32,32,0,0,0,448,32ZM416,168a8,8,0,0,1-8,8H344a8,8,0,0,1-8-8V104a8,8,0,0,1,8-8h64a8,8,0,0,1,8,8Z"></path><path d="M208,32H64A32,32,0,0,0,32,64V208a32,32,0,0,0,32,32H208a32,32,0,0,0,32-32V64A32,32,0,0,0,208,32ZM176,168a8,8,0,0,1-8,8H104a8,8,0,0,1-8-8V104a8,8,0,0,1,8-8h64a8,8,0,0,1,8,8Z"></path><path d="M208,272H64a32,32,0,0,0-32,32V448a32,32,0,0,0,32,32H208a32,32,0,0,0,32-32V304A32,32,0,0,0,208,272ZM176,408a8,8,0,0,1-8,8H104a8,8,0,0,1-8-8V344a8,8,0,0,1,8-8h64a8,8,0,0,1,8,8Z"></path></g></svg>
